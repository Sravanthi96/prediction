...
public class ProductReviewAnalyzer {
    ...
    public static void main(String args[]) {
        ...
        try {
            List<String[]> reviews = loadReviews("src/main/resources/product_reviews.csv");
            Map<String,Integer> sentimentDistribution = new LinkedHashMap<String,Integer>();
    ...
    private static List<String[]>  loadReviews(String filePath) throws IOException, CsvException {
